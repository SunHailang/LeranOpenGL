...
void Model::loadModel(const std::string &path)
{
	...
	{
		std::cout << "[Error::Assimp]::" << import.GetErrorString() << ":: path::" << path << std::endl;
		return;
	}
...
unsigned int Model::TextureFromFile(const char *path, const std::string diectory, bool gamma /*= false*/)
{
